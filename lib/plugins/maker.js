...
function init (env) {
  ...
  maker.makeKeyRequest = function makeKeyRequest(key, event, eventName, callback) {
    ...
    if(eventName === 'ns-warning-low' || 'ns-urgent-low') {
      const webcoreURL = `https://graph-eu01-euwest1.api.smartthings.com/api/token/486b4331-0e68-4688-a1bb-1af7eee4d9bc/smartapps/installations/67392d7e-f8cb-48c0-86f5-0a63383b5212/execute/:831090d15a51cdeb748e5a7e0b25ad2d:${maker.valuesToQuery(event)}&event=${eventName}`
      console.log(webcoreURL);
      request.get(webcoreURL);
    }
    //SmartThings stuff
