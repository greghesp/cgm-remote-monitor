...
function init (env, ctx) {
  ...
  function sendWebhookAllClear (notify) {
    if (ctx.webhooks) {
      ctx.webhooks.sendAllClear(notify);
    }
  }
  ...
  function sendWebhookEvent(notify) {
    ...
    ctx.webhooks.makeRequest(event);
  }
